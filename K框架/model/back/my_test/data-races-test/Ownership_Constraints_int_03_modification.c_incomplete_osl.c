/* 
Filename: Ownership_Constraints_03.c
*/
/*
 * @description
 ...
 * Flow Variant: 02 Control flow: if(5==5) and if(5!=5)
 *
 * */



fn Ownership_Constraints_03_bad() ->#voidTy{
    decl data1;
decl data2;
...
fn Ownership_Constraints_03_good() ->#voidTy{
    decl data3;
decl data4;
...
fn main(argc:#own(copy), argv:#own()) -> #own(copy){
    ...
    call Ownership_Constraints_03_good();
    
    
    call Ownership_Constraints_03_bad();
