/* 
Filename: Ownership_Constraints_04.c
*/
/*
 * @description
...
fn Ownership_Constraints_04_bad() ->#voidTy{
    decl data1;
decl data2;
...
fn Ownership_Constraints_04_good() ->#voidTy{
    decl data3;
decl data4;
...
fn main(argc:#own(copy), argv:#own()) -> #own(copy){
    ...
    call Ownership_Constraints_04_good();
    
    
    call Ownership_Constraints_04_bad();
