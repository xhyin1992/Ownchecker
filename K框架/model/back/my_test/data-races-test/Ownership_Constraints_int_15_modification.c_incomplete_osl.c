/* 
Filename: Ownership_Constraints_15.c
*/
/*
 * @description
...
fn Ownership_Constraints_15_bad() ->#voidTy{
    decl data1;
decl data2;
...
fn Ownership_Constraints_15_good() ->#voidTy{
    decl data3;
decl data4;
   ...
   //switch case statement
      ...
      @{    //switch case statement /* the code below will never run*/
...
fn main(argc:#own(copy), argv:#own()) -> #own(copy){
    ...
    call Ownership_Constraints_15_good();
    
    
    call Ownership_Constraints_15_bad();
