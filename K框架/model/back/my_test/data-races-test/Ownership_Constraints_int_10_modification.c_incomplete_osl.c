/* 
Filename: Ownership_Constraints_10.c
*/
/*
 * @description
...
fn Ownership_Constraints_10_bad() ->#voidTy{
    decl data1;
decl data2;
...
fn Ownership_Constraints_10_good() ->#voidTy{
    decl data3;
decl data4;
...
fn main(argc:#own(copy), argv:#own()) -> #own(copy){
    ...
    call Ownership_Constraints_10_good();
    
    
    call Ownership_Constraints_10_bad();
