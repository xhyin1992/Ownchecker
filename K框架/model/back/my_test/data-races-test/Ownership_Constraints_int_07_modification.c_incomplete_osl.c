/* 
Filename: Ownership_Constraints_07.c
*/
/*
 * @description
...
fn Ownership_Constraints_07_bad() ->#voidTy{
    decl data1;
decl data2;
...
fn Ownership_Constraints_07_good() ->#voidTy{
    decl data3;
decl data4;
...
fn main(argc:#own(copy), argv:#own()) -> #own(copy){
    ...
    call Ownership_Constraints_07_good();
    
    
    call Ownership_Constraints_07_bad();
