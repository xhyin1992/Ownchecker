/* 
Filename: Ownership_Constraints_13.c
*/
/*
 * @description
...
fn Ownership_Constraints_13_bad() ->#voidTy{
    decl data1;
decl data2;
...
fn Ownership_Constraints_13_good() ->#voidTy{
    decl data3;
decl data4;
...
fn main(argc:#own(copy), argv:#own()) -> #own(copy){
    ...
    call Ownership_Constraints_13_good();
    
    
    call Ownership_Constraints_13_bad();
